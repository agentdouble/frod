...
EXTRACTION_FIELD_LABELS = {
    ...
    "national_identifier": "Identifiant national",
...
_IDENTIFIER_LABELS = {
    ...
    "OCR_SIREN_": "SIREN",
    "OCR_SIRET_": "SIRET",
    "OCR_BELGIAN_RRN_": "Numéro de registre national belge",
...
def _identifier_label_and_field(code: str) -> tuple[str, str | None]:
    field_codes = {
        ...
        "OCR_BELGIAN_RRN_": "national_identifier",
...
def _ocr_observation_copy(observation: dict[str, Any]) -> tuple[str, str]:
    ...
    copies = {
        ...
        "OCR_BELGIAN_RRN_INVALID": (
            "Numéro de registre national belge à vérifier",
            "Le numéro ne respecte pas la date encodée ou la clé de contrôle belge.",
        ),
        "OCR_EU_VAT_INVALID": (
